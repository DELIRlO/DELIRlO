  ...
  <tr>
    ...
    <td width="30%" valign="center" style="padding: 10px; border: none; vertical-align: top;">
      <table style="border: none;">
        <tr><strong><td><img height="130" src="https://streak-stats.demolab.com?user=delirlo&locale=pt-br&mode=weekly&theme=omni&hide_border=false&border_radius=5&date_format=M%20j%5B,%20Y%5D" height="156" alt="streak graph"  /></td></strong></td> &nbsp;&nbsp;</tr>
      </table>
    <td width="30%" valign="center" style="padding: 10px; border: none; vertical-align: top;">
      <table width="100%" style="border-collapse: collapse; border: none;">
        <tr>
