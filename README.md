...
<table width="100%" style="border-collapse: collapse; border: none; table-layout: fixed;">
  <tr>
    <!-- Streak Stats -->
    <td width="27%" align="center" valign="middle" style="padding: 10px; border: none; height: 300px;">
    ...
    <!-- GitHub Profile Card -->
    <td width="73%" align="center" valign="middle" style="padding: 10px; border: none; height: 300px;">
